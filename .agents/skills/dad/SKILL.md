---
name: dad
description: Plan and run tracked development work through issues, sprint branches, tests, and pull requests.
---
...
Read only the selected reference. Each starts with the shared bootstrap.
